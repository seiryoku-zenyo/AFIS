...
setThreshold(th, 255);
run("Convert to Mask");
run("Specify...", "width=1000 height=15 x=0 y=242 scaled");
setForegroundColor(0, 0, 0);
run("Fill", "slice");
run("Specify...", "width=15 height=500 x=242 y=0 scaled");
setForegroundColor(0, 0, 0);
run("Fill", "slice");
run("Specify...", "width=15 height=500 x=492 y=0 scaled");
setForegroundColor(0, 0, 0);
run("Fill", "slice");
run("Specify...", "width=15 height=500 x=742 y=0 scaled");
setForegroundColor(0, 0, 0);
run("Fill", "slice");
run("Select All");
run("Invert");

//measure area of capillaries
run("Set Measurements...", "area integrated redirect=None decimal=3");
selectWindow("capillaries.tif");
run("Analyze Particles...", "size=1-3000 circularity=0.00-1.00 show=Outlines display");
saveAs("Results");
selectWindow("Drawing of capillaries.tif");
saveAs("Drawing of capillaries.tif");
...
//creating mask with capillaries and white_bodies
selectWindow("capillaries.tif");
run("Invert");
run("Create Selection");
run("Make Inverse");
imageCalculator("AND create", "white_bodies.tif","capillaries.tif");
selectWindow("Result of white_bodies.tif");
run("Create Selection");
